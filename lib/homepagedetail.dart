                  ...
                  return ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return Container(
                        ...
                        decoration: BoxDecoration(color: const Color(0XFFFF2882), borderRadius: BorderRadius.circular(20)),
                        child: Text("${homepagedetailController.listData[index]}", style: const TextStyle(fontSize: 14, color: Colors.white)),
                      );
                    },
                  );
                }),
